...
public class EquityUI : Form
{
	...
	private BindingSource mCapitalBindingSource;
	...
	private void InitializeComponent()
	{
		...
		this.mCapitalBindingSource = new System.Windows.Forms.BindingSource(this.components);
		...
		((System.ComponentModel.ISupportInitialize)this.mCapitalBindingSource).BeginInit();
		...
		this.mCapitalBindingSource.DataSource = typeof(Oci.Athena.DataSource.Hexin.EquityRecord);
		...
		this.mContentView.Size = new System.Drawing.Size(292, 473);
		...
		this.w3DataGridViewTextBoxColumn.HeaderText = "总股本";
		...
		this.w4DataGridViewTextBoxColumn.HeaderText = "暂时锁定股";
		...
		this.w11DataGridViewTextBoxColumn.HeaderText = "流通A股";
		...
		this.w12DataGridViewTextBoxColumn.HeaderText = "流通B股";
		...
		this.w13DataGridViewTextBoxColumn.HeaderText = "流通H股";
		...
		((System.ComponentModel.ISupportInitialize)this.mCapitalBindingSource).EndInit();
	...
	public void Initialize(string filename)
	{
		...
		{
			m_File = default(EquityFile);
			flag = EquityFile.Read(ref m_File, stream);
		}
		if (!flag)
		{
			return;
	...
	{
		mCapitalBindingSource.SuspendBinding();
		try
		{
			mCapitalBindingSource.Clear();
			...
			for (int i = 0; i < complexIndexRecord.RecordNumber; i++)
			{
				...
				{
					mCapitalBindingSource.Add(m_File.RecordList[i + complexIndexRecord.Position]);
				}
			}
			mCapitalBindingSource.ResetBindings(metadataChanged: false);
		}
		finally
		{
			mCapitalBindingSource.ResumeBinding();
		}
	}
}
