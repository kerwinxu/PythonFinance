...
public class StockholderUI : Form
{
	private IContainer components;

	private DataGridView mContentView;

	private BindingSource mStockholderBindingSource;
	...
	private StockholderFile m_File;
	...
	private void InitializeComponent()
	{
		...
		this.mStockholderBindingSource = new System.Windows.Forms.BindingSource(this.components);
		...
		((System.ComponentModel.ISupportInitialize)this.mStockholderBindingSource).BeginInit();
		...
		this.mComplexView.TabIndex = 12;
		this.mStockholderBindingSource.DataSource = typeof(Oci.Athena.DataSource.Hexin.StockholderRecord);
		...
		this.w2DataGridViewTextBoxColumn.HeaderText = "股东一名称";
		...
		this.w3DataGridViewTextBoxColumn.HeaderText = "股东一持股";
		...
		this.w4DataGridViewTextBoxColumn.HeaderText = "股东二名称";
		...
		this.w5DataGridViewTextBoxColumn.HeaderText = "股东二持股";
		...
		this.w6DataGridViewTextBoxColumn.HeaderText = "股东三名称";
		...
		this.w7DataGridViewTextBoxColumn.HeaderText = "股东三持股";
		...
		this.w8DataGridViewTextBoxColumn.HeaderText = "股东四名称";
		...
		this.w9DataGridViewTextBoxColumn.HeaderText = "股东四持股";
		...
		this.w10DataGridViewTextBoxColumn.HeaderText = "股东五名称";
		...
		this.w11DataGridViewTextBoxColumn.HeaderText = "股东五持股";
		...
		this.w12DataGridViewTextBoxColumn.HeaderText = "股东六名称";
		...
		this.w13DataGridViewTextBoxColumn.HeaderText = "股东六持股";
		...
		this.w14DataGridViewTextBoxColumn.HeaderText = "股东七名称";
		...
		this.w15DataGridViewTextBoxColumn.HeaderText = "股东七持股";
		...
		this.w16DataGridViewTextBoxColumn.HeaderText = "股东八名称";
		...
		this.w17DataGridViewTextBoxColumn.HeaderText = "股东八持股";
		...
		this.w18DataGridViewTextBoxColumn.HeaderText = "股东九名称";
		...
		this.w19DataGridViewTextBoxColumn.HeaderText = "股东九持股";
		...
		this.w20DataGridViewTextBoxColumn.HeaderText = "股东十名称";
		...
		this.w21DataGridViewTextBoxColumn.HeaderText = "股东十持股";
		...
		((System.ComponentModel.ISupportInitialize)this.mStockholderBindingSource).EndInit();
		((System.ComponentModel.ISupportInitialize)this.mComplexBindingSource).EndInit();
		base.ResumeLayout(false);
	}

	public StockholderUI()
	{
		InitializeComponent();
	}
	...
	public void Initialize(string filename)
	{
		...
		{
			m_File = default(StockholderFile);
			flag = StockholderFile.Read(ref m_File, stream);
		}
		if (!flag)
		{
			return;
	...
	{
		mStockholderBindingSource.SuspendBinding();
		try
		{
			mStockholderBindingSource.Clear();
			...
			for (int i = 0; i < complexIndexRecord.RecordNumber; i++)
			{
				...
				{
					mStockholderBindingSource.Add(m_File.RecordList[i + complexIndexRecord.Position]);
				}
			}
			mStockholderBindingSource.ResetBindings(metadataChanged: false);
		}
		finally
		{
			mStockholderBindingSource.ResumeBinding();
		}
	}
}
